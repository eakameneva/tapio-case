...
export const addPost = createAsyncThunk('posts/addPost', async (newPost: Partial<IPost>, { rejectWithValue }) => {
  try {
...
export const updatePost = createAsyncThunk('posts/updatePost', async (post: IPost, { rejectWithValue }) => {
...
export const fetchAuthors = createAsyncThunk('posts/fetchAuthors', async (_, { rejectWithValue }) => {
  try {
